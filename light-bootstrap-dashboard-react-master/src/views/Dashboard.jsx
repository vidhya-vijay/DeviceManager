...
class Dashboard extends Component {
  ...
  fetchMessageList(deviceParam, severityParam){
    ...
    if(sParam == undefined)
       sParam = '';
    fetch("http://54.213.83.63:8080/deviceManager/messages?deviceName="+dParam+"&severity="+sParam)
      .then(res => res.json())
      .then(
        (result) => {
          this.setState({
  ...
  fetchDeviceStatistics(deviceParam){
    ...
    if(deviceName==undefined)
       deviceName=''
    fetch("http://54.213.83.63:8080/deviceManager/device/stats?deviceName="+deviceName)
      .then(res => res.json())
      .then(
        (result) => {
  ...
  fetchMessageStatistics(deviceParam, sevParam){
    ...
    fetch("http://54.213.83.63:8080/deviceManager/message/stats?deviceName="+dParam+"&severity="+sParam)
      .then(res => res.json())
      .then(
        (result) => {
          var l = [];
